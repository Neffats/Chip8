...
func TestSkipEqualVal(t *testing.T) {
	tt := []struct {
		...
		{name: "Equal reg/value.", inst: 0x330A, reg: treg{reg: 0x03, value: 10}, expected: PCInit + 2, expectErr: false},
...
func TestSkipNotEqualVal(t *testing.T) {
	tt := []struct {
		...
		{name: "Unequal reg/value", inst: 0x4AFF, reg: treg{reg: 0x0A, value: 10}, expected: PCInit + 2, expectErr: false},
...
func TestSkipEqualReg(t *testing.T) {
	tt := []struct {
		...
		{name: "Equal reg/reg.", inst: 0x51E0,
			...
			expected: PCInit + 2, expectErr: false},
